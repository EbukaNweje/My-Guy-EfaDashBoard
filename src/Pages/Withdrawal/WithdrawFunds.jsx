...
const WithdrawFunds = () => {
    ...
    const url = `https://boss2-k-back-end.vercel.app/api/requestwithdrawcode/${id}`
    const urlll = `https://boss2-k-back-end.vercel.app/api/withdraw/${id}`
    const urlprofit = `https://boss2-k-back-end.vercel.app/api/transferprofittoaccount/${id}`
    const urlemail = `https://boss2-k-back-end.vercel.app/api/withdrawalemailsend/${id}`
