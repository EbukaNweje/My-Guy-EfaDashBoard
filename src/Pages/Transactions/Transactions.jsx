...
const Transactions = () => {
    ...
    const url = `https://my-guy-efa-back-end.vercel.app/api/getalldeposit/${id}`
    const url2 = `https://my-guy-efa-back-end.vercel.app/api/getallwithdrawal/${id}`
    const url3 = `https://my-guy-efa-back-end.vercel.app/api/getalltransactions/${id}`
